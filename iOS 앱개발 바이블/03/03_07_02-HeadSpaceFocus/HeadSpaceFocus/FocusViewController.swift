...
class FocusViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.delegate = self // 뭘 눌렀는지 출력할 수 있게하기 위해
        updateButtonTitle()
    }
...
extension FocusViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) { // 뭘 눌렀는지 출력
        ...
        vc.title = item.title // 누른 항목이 타이틀로 되도록 -> 메인뷰가 라지타이틀이라 이 타이틀도 라지타이틀로 나옴
